    ...
    return Scaffold(
        ...
        child: Container(
          ...
          child: ListView(
            children: [
              ...
              ListTile(
                leading: Icon(Icons.phone_outlined, size: 35, color: Colors.white,),
                title: Text(
                  'Contact Us',
                  style: TextStyle(fontSize: 30,color: Colors.white),
                ),
              ...
              ListTile(
                leading: Icon(Icons.info_outline, size: 35, color: Colors.white,),
                title: Text(
                  'About Us',
                  style: TextStyle(fontSize: 30,color: Colors.white),
                ),
      ...
      bottomNavigationBar: GNav(
        ...
        tabs: [
          ...
          GButton(icon: Icons.history_outlined, iconSize: 35, iconColor: Colors.white,),
          GButton(icon: Icons.account_circle_outlined, iconSize: 35, iconColor: Colors.white,),]
      ),
      body: Column(
        children: [
          SizedBox(height: 20,),
